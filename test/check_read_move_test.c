...
char mass[9][9] =	{{'8','r', 'n', 'b', 'q', 'k', 'b', 'n', 'r'},
			{'7','p', 'p', 'p', 'p', 'p', 'p', 'p', 'p'},
...
{
    step_integer[0] = 1; step_integer[1] = 6;
    step_integer[3] = 1; step_integer[4] = 5;
    ASSERT_EQUAL(0, WhitePawnMove(step_integer,mass));
}

CTEST(read_figures, WhiteHorse)
{
    step_integer[0] = 2; step_integer[1] = 7;
    step_integer[3] = 3; step_integer[4] = 5;
    ASSERT_EQUAL(0, WhiteHorseMove(step_integer,mass));
}

CTEST(read_figures, BlackHorse)
{
    step_integer[0] = 2; step_integer[1] = 0;
    step_integer[3] = 3; step_integer[4] = 2;
    ASSERT_EQUAL(0, BlackHorseMove(step_integer,mass));
}

CTEST(read_figures, WhiteBishop)
{
    step_integer[0] = 3; step_integer[1] = 7;
    step_integer[3] = 5; step_integer[4] = 5;
